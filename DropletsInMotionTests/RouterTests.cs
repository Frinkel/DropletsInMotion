...
namespace DropletsInMotionTests
{
    public class RouterTests : TestBase
    {
        ...
        [Test]
        public void AStarManyDropletsSimpleRoute2()
        {
            ...
            var commands1 = new List<IDropletCommand>() { dropletCommandA1 };
            var commands2 = new List<IDropletCommand>() { dropletCommandA2 };
            var commands3 = new List<IDropletCommand>() { dropletCommandA3 };
            var commands4 = new List<IDropletCommand>() { dropletCommandA4 };
            var commands5 = new List<IDropletCommand>() { dropletCommandA5 };
            ...
            _ = _routerService.Route(agents, commands1, contaminationMap, 0);
            _ = _routerService.Route(agents, commands2, contaminationMap, 0);
            _ = _routerService.Route(agents, commands3, contaminationMap, 0);
            _ = _routerService.Route(agents, commands4, contaminationMap, 0);
            _ = _routerService.Route(agents, commands5, contaminationMap, 0);
