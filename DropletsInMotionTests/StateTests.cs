...
//            var agent = new Agent("d1", 1, 1, 400);
//            agents.Add("d1", agent);


//            IDropletCommand dropletCommand = new Move("d1", 10, 1);

//            List<Constraint> initialConstraints = new List<Constraint>();
//            Constraint c = new Constraint(agent.DropletName, (5, 1));
//            Constraint c1 = new Constraint(agent.DropletName, (5, 2));
//            Constraint c2 = new Constraint(agent.DropletName, (5, 0));
//            initialConstraints.Add(c);
//            initialConstraints.Add(c1);
//            initialConstraints.Add(c2);

//            State s0 = new State(agents, agent.DropletName, contamination, initialConstraints, dropletCommand, _contaminationService, _platformRepository, _templateRepository);

//            AstarRouter astarRouter = new AstarRouter();

//            Frontier frontier = new Frontier();

//            var s = astarRouter.Search(s0, frontier);
